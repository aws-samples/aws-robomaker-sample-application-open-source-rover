...
CONFIG_KEYS = {
    BUCKET_KEY: ['cfg.simulation.outputLocation', 'cfg.robotApp.s3Bucket', 'cfg.simulationApp.s3Bucket'],
...
# We'll need bucket elsewhere too
bucket = None
for key in CONFIG_KEYS:
    ...
    for target_keys in CONFIG_KEYS[key]:
        cfg = sim_config
